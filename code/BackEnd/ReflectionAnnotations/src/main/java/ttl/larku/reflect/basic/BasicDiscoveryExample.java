...
/**
 * BasicDiscoveryExample provides a basic example of how you can "interrogate" a
 * dynamically loaded class for information about its structure.
 * 
...
public class BasicDiscoveryExample {
	...
	public static void main(String[] args) {
		//args = new String[] { "ttl.larku.service.StudentService" };
		args = new String[] { "java.util.concurrent.ConcurrentHashMap" };
		if (args.length == 0) {
