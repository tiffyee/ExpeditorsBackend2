...
@Tag("expensive")
public class RestTemplateSpringTest {
...
//        return s;
    ...
    public Student getStudentWithId(int id) throws IOException {
        ...
        ResponseEntity<RestResultWrapper<Student>> response = rt.exchange("/adminrest/student/{id}",
...
//        List<Student> students = mapper.convertValue(rr.getEntity(), listType);
    ...
    public void testUpdateOneStudent() throws IOException {
        ...
        ResponseEntity<RestResultWrapper<Void>> response = rt.exchange(rootUrl,
