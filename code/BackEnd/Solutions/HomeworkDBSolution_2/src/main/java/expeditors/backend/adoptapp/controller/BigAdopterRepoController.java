...
import expeditors.backend.adoptapp.service.BigAdopterRepoService;
 ...
 */
@RestController
@RequestMapping("/bigpetreposervice")
public class BigAdopterRepoController {

    private BigAdopterRepoService adopterService;
    private UriCreator uriCreator;

    public BigAdopterRepoController(BigAdopterRepoService adopterService,
