...
public class TrackControllerUnitTest {
    ...
    public void testGetAllWithSomeParams() throws Exception {
        ...
        Map<String, String> queryStrings = Map.of("c.title", "April");
        //Mockito.when(trackService.getTracksBy(queryStrings)).thenReturn(List.of(allTracks.get(1)));
        Mockito.when(trackService.getTracksBySearchSpec(queryStrings)).thenReturn(List.of(allTracks.get(1)));
        ...
        Mockito.verify(trackService).getTracksBySearchSpec(queryStrings);
