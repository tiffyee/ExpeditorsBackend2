    ...
    $.fn.extend({
        ...
        uniqueId: function () {
            return this.each(function () {
                if (!this.artistId) {
                    this.artistId = "ui-artistId-" + (++uuid);
                }
            });
        },
        ...
        removeUniqueId: function () {
            return this.each(function () {
                if (runiqueId.test(this.artistId)) {
                    $(this).removeAttr("artistId");
                }
            });
        }
    });
...
(function ($, undefined) {
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _createHelper: function (event) {
            ...
            var o = this.options;
            var helper = $.isFunction(o.helper) ? $(o.helper.apply(this.element[0], [event])) : (o.helper == 'clone' ? this.element.clone().removeAttr('artistId') : this.element);
            ...
            $.each(inst.sortables, function (i) {
                ...
                if (innermostIntersecting) {
                    ...
                    if (!this.instance.isOver) {
                        ...
                        this.instance.currentItem = $(that).clone().removeAttr('artistId').appendTo(this.instance.element).data("sortable-item", true);
...
(function ($, undefined) {
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        serialize: function (o) {
            ...
            $(items).each(function () {
                var res = ($(o.item || this).attr(o.attribute || 'artistId') || '').match(o.expression || (/(.+)[-=_](.+)/));
        ...
        toArray: function (o) {
            ...
            items.each(function () {
                ret.push($(o.item || this).attr(o.attribute || 'artistId') || '');
            });
            return ret;
