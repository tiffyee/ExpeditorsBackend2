...
-- ALTER SCHEMA public OWNER TO larku;
...
ALTER DOMAIN public."bıgınt" OWNER TO lark;

--
-- Name: mpaa_rating; Type: TYPE; Schema: public; Owner: lark
--
...
ALTER TYPE public.mpaa_rating OWNER TO lark;

--
-- Name: year; Type: DOMAIN; Schema: public; Owner: lark
--
...
ALTER DOMAIN public.year OWNER TO lark;

--
-- Name: _group_concat(text, text); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO lark;

--
-- Name: film_in_stock(integer, integer); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO lark;

--
-- Name: film_not_in_stock(integer, integer); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO lark;

--
-- Name: get_customer_balance(integer, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp with time zone) OWNER TO lark;

--
-- Name: inventory_held_by_customer(integer); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO lark;

--
-- Name: inventory_in_stock(integer); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO lark;

--
-- Name: last_day(timestamp with time zone); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.last_day(timestamp with time zone) OWNER TO lark;

--
-- Name: last_updated(); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.last_updated() OWNER TO lark;

--
-- Name: customer_customer_id_seq; Type: SEQUENCE; Schema: public; Owner: lark
--
...
ALTER TABLE public.customer_customer_id_seq OWNER TO lark;
...
--
-- Name: customer; Type: TABLE; Schema: public; Owner: lark
--
...
ALTER TABLE public.customer OWNER TO lark;

--
-- Name: rewards_report(integer, numeric); Type: FUNCTION; Schema: public; Owner: lark
--
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO lark;

--
-- Name: group_concat(text); Type: AGGREGATE; Schema: public; Owner: lark
--
...
ALTER AGGREGATE public.group_concat(text) OWNER TO lark;

--
-- Name: actor_actor_id_seq; Type: SEQUENCE; Schema: public; Owner: lark
--
...
ALTER TABLE public.actor_actor_id_seq OWNER TO lark;
...
ALTER TABLE public.actor OWNER TO larku;
...
ALTER TABLE public.category_category_id_seq OWNER TO larku;
...
ALTER TABLE public.category OWNER TO larku;
...
ALTER TABLE public.film_film_id_seq OWNER TO larku;
...
ALTER TABLE public.film OWNER TO larku;
...
ALTER TABLE public.film_actor OWNER TO larku;
...
ALTER TABLE public.film_category OWNER TO larku;
...
ALTER TABLE public.actor_info OWNER TO larku;
...
ALTER TABLE public.address_address_id_seq OWNER TO larku;
...
ALTER TABLE public.address OWNER TO larku;
...
ALTER TABLE public.city_city_id_seq OWNER TO larku;
...
ALTER TABLE public.city OWNER TO larku;
...
ALTER TABLE public.country_country_id_seq OWNER TO larku;
...
ALTER TABLE public.country OWNER TO larku;
...
ALTER TABLE public.customer_list OWNER TO larku;
...
ALTER TABLE public.film_list OWNER TO larku;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO larku;
...
ALTER TABLE public.inventory OWNER TO larku;
...
ALTER TABLE public.language_language_id_seq OWNER TO larku;
...
ALTER TABLE public.language OWNER TO larku;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO larku;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO larku;
...
ALTER TABLE public.payment OWNER TO larku;
...
ALTER TABLE public.payment_p2022_01 OWNER TO larku;
...
ALTER TABLE public.payment_p2022_02 OWNER TO larku;
...
ALTER TABLE public.payment_p2022_03 OWNER TO larku;
...
ALTER TABLE public.payment_p2022_04 OWNER TO larku;
...
ALTER TABLE public.payment_p2022_05 OWNER TO larku;
...
ALTER TABLE public.payment_p2022_06 OWNER TO larku;
...
ALTER TABLE public.payment_p2022_07 OWNER TO larku;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO larku;
...
ALTER TABLE public.rental OWNER TO larku;
...
ALTER TABLE public.rental_by_category OWNER TO larku;
...
ALTER TABLE public.sales_by_film_category OWNER TO larku;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO larku;
...
ALTER TABLE public.staff OWNER TO larku;
...
ALTER TABLE public.store_store_id_seq OWNER TO larku;
...
ALTER TABLE public.store OWNER TO larku;
...
ALTER TABLE public.sales_by_store OWNER TO larku;
...
ALTER TABLE public.staff_list OWNER TO larku;
