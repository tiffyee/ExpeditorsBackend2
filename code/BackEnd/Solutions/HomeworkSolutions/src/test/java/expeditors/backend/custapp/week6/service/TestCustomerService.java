package expeditors.backend.custapp.week6.service;
...
@ContextConfiguration(classes = {CustAppConfig.class})
...
//        customerService = new CustomerService();
    ...
    public void testFindByExample() {
        ...
        Map<String, Object> example = Map.of("name", "Joey", "dob", LocalDate.of(1990, 6, 9));
