...
public class AdoptionApp {
    public static void main(String[] args) {
        ...
        adopters.add(new Adopter(1,"John Doe","333-333-3333", LocalDate.of(2024, 3, 11),pet1));
        adopters.add(new Adopter(2,"Jane Doe","123456-7890", LocalDate.of(2024, 3, 12),pet2));
