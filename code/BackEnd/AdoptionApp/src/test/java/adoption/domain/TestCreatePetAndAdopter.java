...
public class TestCreatePetAndAdopter {
    ...
    public void testValidAdopterName(){
        Pet pet1 = new Pet(1, Pet.PetType.CAT,"Marble","Tabby");
        Adopter adopter1 = new Adopter(1,"John Doe","333-333-3333",LocalDate.of(2024, 3, 11),pet1);
    ...
    public void testNullAdopterName(){
        Pet pet1 = new Pet(1, Pet.PetType.CAT,"Marble","Tabby");
        assertThrows(IllegalArgumentException.class,() -> new Adopter(1,null,"333-333-3333",LocalDate.of(2024, 3, 11),pet1));
    }

    @Test
    public void testBlankAdopterName(){
        Pet pet1 = new Pet(1, Pet.PetType.CAT,"Marble","Tabby");
        assertThrows(IllegalArgumentException.class,() -> new Adopter(1,"","333-333-3333",LocalDate.of(2024, 3, 11),pet1));
    }

    @Test
    public void testInvalidPhoneNumber(){
        Pet pet1 = new Pet(1, Pet.PetType.CAT,"Marble","Tabby");
        assertThrows(IllegalArgumentException.class,() -> new Adopter(1,"John Doe","(333)333-3333",LocalDate.of(2024, 3, 11),pet1));
    }
