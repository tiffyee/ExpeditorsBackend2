...
@RestController
@RequestMapping("/adminrest/jdbcstudent")
public class StudentRestJdbcController {
    ...
    public StudentRestJdbcController(StudentJdbcService studentService, UriCreator uriCreator) {
