...
@Transactional
@Tag("optional")
public class JdbcTemplateExamplesTest extends SqlScriptBase {
	...
	public void testSimpleInsert() {
		...
		assertEquals(5, keyHolder.getKey().intValue());
	}
	...
	/**
	 * Get A ScheduledClass and all it's students.
	 */
	@Test
	public void testRowMapperComplicated() {
		...
		Map<String, Object> paramValues = new HashMap<>();
		//paramValues.put("startDate", LocalDate.parse("2012-10-10"));
		paramValues.put("startDate", LocalDate.parse("2022-10-10"));
		paramValues.put("code", "MATH-101");
