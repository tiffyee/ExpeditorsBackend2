...
//@Sql(scripts = { "/sql/postgres/4-postgress-larku-data.sql" }, executionPhase= Sql.ExecutionPhase.BEFORE_TEST_METHOD)
...
@Transactional
@Tag("integration")
public class CourseServiceTest extends SqlScriptBase {
