...
@Disabled
public class RestTemplageNoSpringTest {
...
//    String rootUrl = "https://localhost:8443/adminrest/student";
    ...
    public void testGetOneStudentUsingAutoUnmarshalling() throws IOException {
        ...
        ResponseEntity<RestResultWrapper<Student>> response = rt.exchange(oneStudentUrl,
    ...
    public void testGetOneStudentWithManualJson() throws IOException {
        ...
        ResponseEntity<String> response = rt.exchange(oneStudentUrl,
                HttpMethod.GET, httpEntity, String.class, 2);
    ...
    public void testGetOneStudentBadId() throws IOException {
        ...
        HttpEntity<?> entity = new HttpEntity<>(headers);
        ResponseEntity<String> response = rt.exchange(oneStudentUrl,
                HttpMethod.GET, entity, String.class, 10000);
