...
public class RegistrationRestController {
    ...
    private BeanHelpers uriCreator;

    @Autowired
    public RegistrationRestController(RegistrationService registrationService,
                                      ClassService classService, BeanHelpers uriCreator) {
    ...
    public ResponseEntity<?> getScheduledClass(@PathVariable("id") int id) {
        ...
        if (c == null) {
            RestResultWrapper<Student> rr = RestResultWrapper.ofError("ScheduledClass with id: " + id + " not found");
