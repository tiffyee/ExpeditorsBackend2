...
public class InMemoryStudentDAOTest {
    ...
    public void setup() {
        ...
        student1 = new Student(name1, phoneNumber1, LocalDate.of(1999, 10, 10), Status.FULL_TIME);
        student2 = new Student(name2, phoneNumber2, LocalDate.of(2010, 6, 8), Status.HIBERNATING);
